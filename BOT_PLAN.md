...
5. Добавить daily digest по расписанию.
5.1. Привязать daily digest и автоалерты к `CABINET_UPDATE_HOUR`, чтобы не делать выводы до обновления кабинетов.
6. Добавить автоалерт "много рег без депа".
7. Добавить автоалерт "CR просел".
8. Добавить сравнение с медианой за 3-7 дней.
9. Добавить аналитику лага от реги до депа.
10. Добавить экспорт live-статистики из локального хранилища в CSV.
...
- текущий планировщик digest еще не реализован;
